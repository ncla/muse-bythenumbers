...
Route::get('/voting-ballots/{id}/vote-test', 'VotingController@vote')->middleware('auth');
Route::post('/voting-ballots/{id}/vote-test', 'VotingController@vote')->middleware('auth');
