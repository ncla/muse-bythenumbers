 ...
 *
 * THIS IS MODIFIED PATCH TO SUPPORT HEIGHT CALCULATION. VERY DIRTY.
 */
'use strict';
...
exports.default = function (w) {
    ...
    var calculateStyles = function calculateStyles(f) {
        ...
        // hacky patch to calculate based on parent element
        if (f.parentHeightEl !== false) {
            var maxHeight  = $(f.element).closest(f.parentHeightEl).height();

            f.currentFontSize = Math.min(Math.max(f.minSize, f.availableWidth / f.currentWidth * f.previousFontSize), Math.min(maxHeight, f.maxSize));
        } else {
