    ...
    public function getSong($id)
    {
        return DB::table('musicbrainz_songs')
            ->select('musicbrainz_songs.id', 'musicbrainz_songs.name', 'spotify_tracks.track_id AS spotify_track_id', 'spotify_tracks.track_name AS spotify_track_name',
                'spotify_tracks.album_id AS spotify_album_id', 'spotify_tracks.duration_ms', 'spotify_tracks.preview_url_mp3', 'spotify_albums.image_url AS album_image_url')
            ...
            ->leftJoin('spotify_albums', 'spotify_tracks.album_id', '=', 'spotify_albums.album_id')
